...
drop policy if exists "authenticated_can_insert_registros" on public.registros_horarios;
...
drop policy if exists "authenticated_can_update_registros" on public.registros_horarios;
...
drop policy if exists "authenticated_can_delete_registros" on public.registros_horarios;
